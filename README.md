...
```bash
git clone https://github.com/SHRAVANKUMAR00/Fake-Review-Detection.git
...
Feel free to check [issues page](https://github.com/SHRAVANKUMAR00/Fake-Review-Detection/issues).
